          ...
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-lg mx-auto lg:mx-0">
                🔥 India's #1 Free Lenden Ledger Khatabook App! Track lending, borrowing & payments with smart reminders. 
                Perfect digital khata for merchants & small business owners.
              </p>
